...
- Изменил кодировку md_ledger_account_s.csv с IBM866 на UTF-8 с помощью Блокнота++.
 ...
 В дальнейшем можно было бы реализовать предобработку данных с помощью Pandas/NumPY. Это быстрее, эффективнее и можно обрабатывать большие объемы данных. Конечно со Sparkом не сравниться, но это лучше, чем в ручную перебирать данные. 
...
4. Указал какие колонки будет являться первичными ключами, тип данных колонок, могут принимать NULL или нет, длину данных.
...
# 10. Добавим автоматизации с помощью Airflow:
